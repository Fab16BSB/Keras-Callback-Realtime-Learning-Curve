...
local_path = "Pima_Indians_Diabetes.csv"
...
model.compile(optimizer='adam', loss='binary_crossentropy', metrics=['accuracy', LearningCurves.precision, LearningCurves.recall, LearningCurves.f1_score])
...
history = model.fit(featureTrain, labelTrain, batch_size=1, initial_epoch=0, epochs=10, validation_data=(featureTest, labelTest), callbacks=callbackList)
